...
def handover_database(spec):
    ...
    * progress_complete - Total number of task completed
    ...
    #             metadata_update_task.s(),
     ...
     #            )()
    print('changed..............................eee') 
    #(datacheck_task.s(spec, dc_job_id, src_uri)| dbcopy_task.s() | metadata_update_task.s()).apply_async() 
    print("£££££  chain completed       return handover.....................................")             
